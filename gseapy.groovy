...
gmt_file = "" //* @input @description:"Path to a GMT file containing gene sets to use for enrichment analysis. This is optional and only a single file can be used."
excel_file = "" //* @input @description:"Path to an Excel file containing gene sets to use for enrichment analysis. Each sheet will be treated as a separate gene set. Sheet names will be used as gene set names and no header should be present for gene list. This is optional and only a single file can be used."
